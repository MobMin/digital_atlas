...
class WidgetModelGeneratorTest extends TestCase
{
    /**
     * You are not allowed to generate a model if widget does not exist.
     *
     * @return void
     */
    public function testRequiresWidget()
    {
        $this->artisan('project:make:widget:model FakeWidget Frog')
