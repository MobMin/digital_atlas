...
{
    /**
     * You are not allowed to generate a widget with the same name.
     *
     * @return void
     */
    public function testNoDuplicateWidgets()
    {
        $this->artisan('project:make:widget Population')
            ->expectsOutput('That widget name already exists!')
            ->assertExitCode(0);
    }
}
