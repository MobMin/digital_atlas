...
class WidgetCommandGeneratorTest extends TestCase
{
    /**
     * You are not allowed to generate a command if widget does not exist.
     *
     * @return void
     */
    public function testRequiresWidget()
    {
        $this->artisan('project:make:widget:command FakeWidget ImportFrogData')
