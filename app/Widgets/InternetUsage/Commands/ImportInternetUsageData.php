 ...
 *
 */
namespace App\Widgets\InternetUsage\Commands;
 ...
 * Command for widget.
 */
class ImportInternetUsageData extends Command
{
    /**
     ...
     * @access protected
     */
    protected $signature = 'import:internet-usage:data';
     ...
     * @access protected
     */
    protected $description = 'Imports the internet usage CSV file.' .
        ' (drop widget-internet-usage.csv in data directory in the root)';
    ...
    {
        $report = config('widgets.internet_usage.report_filename');
        if ($report == null) {
            $report = 'widget-internet-usage.csv';
        }
        $this->info('Importing internet usage data.');
        ...
        InternetUsage::truncate();
        InternetUsage::insert($data);
