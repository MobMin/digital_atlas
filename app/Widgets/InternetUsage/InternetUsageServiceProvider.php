...
class InternetUsageServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . $ds . 'Views', 'internet-usage');
        $this->loadTranslationsFrom(__DIR__ . $ds . 'Translations', 'internet-usage');
        $this->publishes([
            __DIR__  . $ds . 'Config.php' => config_path('widgets' . $ds . 'internet_usage.php'),
        ]);
