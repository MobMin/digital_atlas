...
class MapsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . $ds . 'Views', 'maps');
        $this->loadTranslationsFrom(__DIR__ . $ds . 'Translations', 'maps');
        $this->publishes([
            __DIR__  . $ds . 'Config.php' => config_path('widgets' . $ds . 'map_coords.php'),
        ]);
        $this->publishes([
            __DIR__  . $ds . 'Geojson' => public_path('widgets' . $ds . 'maps-data'),
        ], 'public');
