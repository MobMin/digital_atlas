...
class BroadbandSubscriptionsServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . $ds . 'Views', 'broadband-subscriptions');
        $this->loadTranslationsFrom(__DIR__ . $ds . 'Translations', 'broadband-subscriptions');
        $this->publishes([
            __DIR__  . $ds . 'Config.php' => config_path('widgets' . $ds . 'broadband_subscriptions.php'),
        ]);
