 ...
 *
 */
namespace App\Widgets\BroadbandSubscriptions\Commands;
 ...
 * Command for widget.
 */
class ImportBroadbandSubscriptionsData extends Command
{
    /**
     ...
     * @access protected
     */
    protected $signature = 'import:broadband-subscriptions:data';
     ...
     * @access protected
     */
    protected $description = 'Imports the broadband subscriptions CSV file.' .
        ' (drop widget-broadband-subscriptions.csv in data directory in the root)';
    ...
    {
        $report = config('widgets.broadband_subscriptions.report_filename');
        if ($report == null) {
            $report = 'widget-broadband-subscriptions.csv';
        }
        $this->info('Importing broadband subscriptions data.');
        ...
        BroadbandSubscription::truncate();
        BroadbandSubscription::insert($data);
