...
class YouTubePopularVideosServiceProvider extends ServiceProvider
{
    /**
     * Register services.
     *
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . $ds . 'Views', 'you-tube-popular-videos');
        $this->loadTranslationsFrom(__DIR__ . $ds . 'Translations', 'you-tube-popular-videos');
        $this->publishes([
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->commands([Commands\ImportPopularVideos::class]);
        }
    }
}
