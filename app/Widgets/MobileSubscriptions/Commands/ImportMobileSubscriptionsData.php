 ...
 * Command for widget.
 */
class ImportMobileSubscriptionsData extends Command
{
    /**
     ...
     * @access protected
     */
    protected $signature = 'import:mobile-subscriptions:data';
     ...
     * @access protected
     */
    protected $description = 'Imports the mobile subscriptions CSV file.' .
        ' (drop widget-mobile-subscriptions.csv in data directory in the root)';
    ...
    {
        $report = config('widgets.mobile_subscriptions.report_filename');
        if ($report == null) {
            $report = 'widget-mobile-subscriptions.csv';
        }
        $this->info('Importing mobile subscriptions data.');
        ...
        MobileSubscription::truncate();
        MobileSubscription::insert($data);
