 ...
 *
 */
namespace App\Widgets\Literacy\Commands;
 ...
 * Command for widget.
 */
class ImportLiteracyData extends Command
{
    /**
     ...
     * @access protected
     */
    protected $signature = 'import:literacy:data';
     ...
     * @access protected
     */
    protected $description = 'Imports the literacy CSV file.' .
        ' (drop widget-literacy.csv in data directory in the root)';
    ...
    {
        $report = config('widgets.literacy.report_filename');
        if ($report == null) {
            $report = 'widget-literacy.csv';
        }
        $this->info('Importing literacy data.');
