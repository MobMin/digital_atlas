...
class LiteracyServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . $ds . 'Views', 'literacy');
        $this->loadTranslationsFrom(__DIR__ . $ds . 'Translations', 'literacy');
        $this->publishes([
            __DIR__  . $ds . 'Config.php' => config_path('widgets' . $ds . 'literacy.php'),
        ]);
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->commands([Commands\ImportLiteracyData::class]);
        }
    }
}
